...
function rotateScene(dx, dy) {
  ...
  let smoothingFactor = 0.05;  // Changed from 0.1 to 0.05 for slower panning
...
function renderdog() {
  ...
  // Draw a neck
  var neck = new Cube();
  neck.color = [0.776, 0.525, 0.259, 1.0];
  neck.textureNum = -2;
  ...
  neck.matrix.scale(0.25, 0.25, 0.25);
  ...
  var head = new Cube();
  head.textureNum = -2;
  head.color = [0.776, 0.525, 0.259, 1.0];
  head.matrix = neckCoordinatesMat;
  head.matrix.translate(0, 0.25, -0.15);
  ...
  ear.color = [0.776, 0.525, 0.259, 1.0];
  ear.textureNum = -2;
  ear.matrix = neckCoordinatesMat;
  ear.matrix = headCoordinatesMat;
  ear.matrix.translate(1.0, 2.5, 1.20);
  ...
  ear2.color = [0.776, 0.525, 0.259, 1.0];
  ear2.textureNum = -2;
  ...
  leg.color = [0.776, 0.525, 0.259, 1.0];
  leg.textureNum = -2;
  ...
  leg2.color = [0.776, 0.525, 0.259, 1.0];
  leg2.textureNum = -2;
  ...
  leg3.color = [0.776, 0.525, 0.259, 1.0];
  leg3.textureNum = -2;
  ...
  leg4.color = [0.776, 0.525, 0.259, 1.0];
  leg4.textureNum = -2;
